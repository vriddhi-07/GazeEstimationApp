...
DEMO_DIAGRAMS = [
    ...
    },
    {
        ...
        "nodes": [],
        "edges": [],
        "question_one": "Who is connected to the fewest number of people in the network?",
        "question_one_options": ["Anne", "Bob", "Elisa", "Carl"],
        "question_two": "Which person is NOT directly connected to Diana?",
        "question_two_options": ["Anne", "Bob", "Carl", "Elisa"],
    },
    {
        ...
        "nodes": [],
        "edges": [],
        "question_one": "From Sobir Rahimov to Habib Abdullayev, what is the minimum number of interchanges to be made?",
